...
from util.metric.misc import check_mkdir
...
# parser.add_argument("-pred", "--prediction", type=str, default="models/VMD/predict_fuse_13/")
parser.add_argument("-pred", "--prediction", type=str, default="output/gdnet/2023-12-21 22:20:47.478589/best_mae_output/results")
parser.add_argument("-o", "--output", type=str, default="output/gdnet/2023-12-21 22:20:47.478589/best_mae_output/results_eval")
parser.add_argument("-exp", "--exp", type=str, default="VMD_ours")
parser.add_argument("-gt", "--mirrormask", type=str, default="/home/xum35/Desktop/File/Dataset/VMD_reorganize/test")
# parser.add_argument("-gt", "--mirrormask", type=str, default="/home/xum35/Desktop/File/Dataset/FMIV_easy_resplit/test")
...
# print(pred_img_name)
gt_img_name = glob(os.path.join(args.mirrormask, "Annotations", "*", "*.png"))
...
with open(os.path.join(output_path, "fast_report.txt"), "a") as f:
